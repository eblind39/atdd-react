...
const TSBasics: React.FC = (): JSX.Element => {
    ...
    useEffect(() => {
        ...
        let personsElegibles: Person[] = persons.filter(person =>
            isElegible(person.age),
        )
                ...
                <Table sx={{minWidth: 650}} aria-label="simple table">
                    ...
                    <TableBody>
                        {persons.map((person: Person) => {
                            person.elegibleType = isElegible(person.age)
                                ? ElegibleType.EQUALORUNDER_25
                                : ElegibleType.OVER_25
                            return (
                                <TableRow
                                    key={person.id}
                                    sx={{
    ...
    return <WithNavBar element={<RenderTSBasics />} />
}
